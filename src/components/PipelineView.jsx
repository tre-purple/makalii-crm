    ...
    <div style={{height:"100%", overflowX:"auto"}}>
      <div style={{display:"flex", gap:10, minWidth:960, height:"100%"}}>
        {STAGES.map(stage => {
          ...
          return (
            <div key={stage} style={{flex:1, minWidth:128, display:"flex", flexDirection:"column", height:"100%"}}>
              {/* Stage header — fixed */}
              <div style={{...card, marginBottom:8, padding:"8px 12px", background:STAGE_BG[stage], borderColor:STAGE_COLORS[stage]+"44", flexShrink:0}}>
